package com.uelbosque.tic_tac_toe.Single;
...
public class Single extends Activity {
    ...
    private boolean checkBoard() {
        ...
        if ((c[1][1] == 0 && c[2][2] == 0 && c[3][3] == 0)
            ...
            Toast.makeText(Single.this, "Game over. You win!",Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(Single.this, "Game over. You lost!",Toast.LENGTH_SHORT).show();
            ...
            if(!empty) {
                gameOver = true;
                Toast.makeText(Single.this, "Game over. It's a draw!",Toast.LENGTH_SHORT).show();
